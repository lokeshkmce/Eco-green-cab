...
export default function SearchWidget({ onSearch, compact = false }) {
  ...
  return (
    <form className={`search-widget ${compact ? 'search-widget-compact' : ''}`} onSubmit={handleSearch}>
      <div className="search-widget-grid">
        {/* City */}
        <div className="search-field">
          <label>
            <MdLocationOn size={14} style={{ marginRight: '2px' }} /> CITY
          </label>
          <CustomSelect 
            value={form.city} 
        ...
        <div className="search-field">
          <label>
            <svg style={{ marginRight: '2px', width: '14px', height: '14px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line></svg>
            BRAND
          </label>
          <CustomSelect 
            value={form.brand} 
        ...
        <div className="search-field">
          <label>
            <svg style={{ marginRight: '2px', width: '14px', height: '14px' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M3 11l2-7h14l2 7"></path><circle cx="7" cy="16" r="1"></circle><circle cx="17" cy="16" r="1"></circle></svg>
            MODEL
          </label>
          <CustomSelect 
            value={form.model} 
